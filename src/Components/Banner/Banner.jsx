...
const Banner = () => {
    return (
        <div data-aos="fade-up" data-aos-duration="3000" id='b'  className='banner' >
            <img src= {profile_img} alt="profile" />
            <h1 >
              <span data-aos="fade-down" data-aos-duration="3000">I'm Tangka Goswami Puja</span>, fronted developer based in Bangladesh.
            </h1>
